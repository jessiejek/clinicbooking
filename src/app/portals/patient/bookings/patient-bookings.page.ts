...
@Component({
  ...
  template: `
    <section class="page-shell">
      ...
      <div class="clinic-card bookings-table-card">
        <div class="table-desktop" *ngIf="filteredBookings.length > 0; else emptyTpl">
        ...
        <div class="table-mobile mobile-cards" *ngIf="filteredBookings.length > 0">
