...
import { Booking, BookingStatus, PaymentMode } from '../../core/models';
...
export const submitBooking = createAction(
  ...
  props<{ paymentMode: PaymentMode; proofType?: string; proofValue?: string }>()
);
